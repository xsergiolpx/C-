...
void disparo(vector<double> &t, vector<double> &x, vector<double> &y);
...
void runge(vector<double> &t, vector<double> &x, vector<double> &y){
	...
	//cout  << right << setw(espacio) << t[i] << right << setw(espacio) << x[i]  << right << setw(espacio) << y[i] << "\n";
	cout << "-----------------------------------------------------------------------------------------------------------------------\n\n\n";
}
...
void disparo(vector<double> &t, vector<double> &x, vector<double> &y){
    ...
    }while(abs(abs(Rd)-abs(R2))>0.0001);
}
